...
| 当前版本 | 3.26.0（ChronoPM-Project + ChronoPM-Portfolio 共用版本线；版本单一事实源为 `scripts/_version.py`） |
...
| 文件总数 | 约 142 个（24 份规则 + 38 个模板 + refresh_views 等脚本 + 包内当前 upgrade + 共享历史链归档 + 1 个回归套件 + 版本/蓝图文件） |

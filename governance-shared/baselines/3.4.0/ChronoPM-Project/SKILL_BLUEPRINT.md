...
| CAP-010 | Resource Management | stable | L3 | `06-file-rules.md`（v3.0.0：09 号单项目资源条款并入 06；跨项目归 Portfolio F-7） | resource-register, transfer-log | 状态与历史分离；v2.1.0：人员信息双层数据流微调（register 唯一事实源）+ 可用性/排期聚合=动态视图硬约束（禁止落盘 shared-resource-index） |

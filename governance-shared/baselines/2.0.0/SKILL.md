...
│   ├── templates/   # 文档模板
│   ├── continuity/  # 项目阶段衔接
│   ├── portfolio/   # 项目集级管理（context/reports/risks/plans/resources/requirements/decisions/reviews）
...
| 日报处理（含个人进度联动） | 00 + 01 + 06 + 17 | 04、07、09、10 |
...
| 待办创建/归属排布（给XX加待办） | 00 | 01、02、07、08、10 |

...
| Request | 用户原始请求 | [文本] |
| Type | 生成类型 | weekly_report / meeting_minutes / requirement_review / design_review / export_excel / export_word / export_pdf / skill_gap（集周报由本包 `portfolio-skill/` 承载，本包不写）。skill_gap 的 Main File=`需求-{短标题}.md`，无 manifest |

...
| `03-task-board-rules.md` | 任务看板字段、状态流转、计划变更/延期计数、超期判定归属、§8 级联传播规则（含状态变更需求一致性、委派跟踪、§8.2 生命周期推导触发） | 任务管理、计划变更/超期 |
...
| `14-self-check-rules.md` | 索引预建、索引一致性、文档处理自查清单（D1-D14）、索引过期检测 | 文档处理后自查、追溯校验 |

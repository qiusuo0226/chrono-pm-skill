# ChronoPM v3.23.1 — An AI Sidekick That Actually Manages Projects
...
- **867 regression cases** guarding every update against breaking existing behavior;
...
Regression tests | 867 cases. Regression test suite (867 cases).
